...
const Portfolio = () => {
  const projects = [
    ...
    { title: 'Taylor Swift Quiz', description: 'This is a timed quiz I created with Taylor Swift questions!', imgsrc: swiftquiz, buttonText: 'Taylor Swift Quiz', link: 'https://akcodes29.github.io/Keriazes-Andrea-Swift-Timed-Quiz/', githublink: 'https://github.com/akcodes29/Keriazes-Andrea-Swift-Timed-Quiz' },
